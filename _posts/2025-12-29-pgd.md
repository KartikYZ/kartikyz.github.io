...
### Relaxation
The adversarial tokens we wish to learn can be expressed as a sequence of $$L$$ tokens, each a 1-hot vector of dimensionality $$|V|$$, where $$V$$ is the model vocabulary. Thus, $$X$$ defined as
$$X \in \{0,1\}^{L \times |V|}$$ represents the discrete token sequence we wish to learn.
